      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-3">
              ...
              <span 
                className="p-2.5 rounded-lg bg-secondary/40 text-foreground/40 transition-colors opacity-60 cursor-default"
          ...
          <div>
            ...
            <ul className="space-y-3.5 text-sm">
              ...
              <li><Link to="/pricing" className="text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5">Pricing <span className="text-[10px] text-emerald-400 bg-emerald-400/15 px-1.5 py-0.5 rounded font-medium">Beta</span></Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-border/50 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-wrap gap-6 text-sm text-muted-foreground">
            ...
            <button
              onClick={() => window.dispatchEvent(new CustomEvent("kareerist-cookie-consent-reopen"))}
