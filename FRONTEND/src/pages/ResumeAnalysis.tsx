...
export default function ResumeAnalysis() {
    ...
    function acceptFile(f: File) {
        ...
        setError(""); setResumeId(null); setSelectedSavedId("");
    }
    ...
    const isAnalysisOpen = showAnalysisPanel && analysisPanelOpen;
    ...
    const canvasContent = (
        <div className="flex-1 flex flex-col overflow-hidden bg-secondary/5">
            <div className="flex-shrink-0 h-10 border-b border-border/30 flex items-center justify-between px-4">
                <div className="flex items-center gap-2">
                    <FileText className="w-3.5 h-3.5 text-primary" />
                    <span className="text-xs font-semibold text-foreground">Resume Preview</span>
                    {file ? (
                        <span className="text-xs text-muted-foreground/50 truncate max-w-xs font-mono">
                            · {file.name}
                        </span>
                ...
                <div className="flex items-center gap-2">
                    {showAnalysisPanel && !analysisPanelOpen && (
                        <button
                            ...
                            className="flex items-center gap-1.5 px-2.5 py-1 rounded text-xs font-semibold bg-primary/10 border border-primary/20 text-primary hover:bg-primary/20 transition-colors cursor-pointer"
                    ...
                    {pdfUrl && (
                        <button
                            ...
                            className="flex items-center gap-1.5 px-2.5 py-1 rounded text-xs font-medium text-muted-foreground hover:text-foreground hover:bg-secondary/60 transition-colors cursor-pointer"
                            title="Download PDF"
                        >
